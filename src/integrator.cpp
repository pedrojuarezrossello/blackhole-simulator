...
void schwarzschild_integrator::send_data() {
...
void schwarzschild_integrator::send_initial_data() {
	message data(radii.size());
	size_t N = radii.size();
	size_t i = 0;
	for (; i + subproblem_size <= N; i += subproblem_size) {
...
void kerr_integrator::send_data() {
	message data(radii.size());
	size_t N = radii.size();
	size_t i = 0;
...
void kerr_integrator::send_initial_data() {
	message data(radii.size());
	size_t N = radii.size();
	size_t i = 0;
	for (; i + subproblem_size <= N; i += subproblem_size) {
